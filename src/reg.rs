...
pub const REG_BG_AFFINE: Ptr<u16> = Ptr::from_u32(0x04000000);
pub const REG_VCOUNT: Ptr<u16> = Ptr::from_u32(0x04000006);
pub const REG_BGCNT: Ptr<u16> = Ptr::from_u32(0x04000008);
pub const REG_BG_OFS: Ptr<u16> = Ptr::from_u32(0x04000010);
pub const REG_BG_VOFS: Ptr<u16> = Ptr::from_u32(0x04000012);
